                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <div>
                      ...
                      <input
                        type="text"
                        value={values.locationCoordinates[0].toFixed(6)}
                        readOnly
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={values.locationCoordinates[1].toFixed(6)}
                        readOnly
                        className="shadow-sm bg-gray-100 block w-full sm:text-sm border-gray-300 rounded-md"
                      />
                    </div>
                  </div>
                  <ErrorMessage name="locationCoordinates" component="div" className="text-red-500 text-sm" />
                </div>
            ...
            <div className="md:w-1/2">
              ...
              <div className="h-96 w-full">
                <MapContainer center={[0, 0]} zoom={2} style={{ height: "100%", width: "100%" }}>
                  ...
                  <MapMarker setFieldValue={setFieldValue} />
                </MapContainer>
              </div>
            </div>
          </>
