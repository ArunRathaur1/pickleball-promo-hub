...
export default function TrustedBrands() {
  ...
  const brands = [
    { src: hero1, alt: "Lifeaid",link:"https://www.sixzeropickleball.com/?srsltid=AfmBOoogHgRsZW2x0UK5dSwmVSKP-22MCYfvULNjzYpb7_YmbPr224wp" },
    { src:hero2, alt: "Organifi",link:"https://globalsports.net.in/" },
    { src: hero3, alt: "Vuori",link:"https://itsgoa.com/aguada-pickleball-arena"},
    { src: hero4, alt: "Franklin Pickleball",link:"https://www.dupr.com/" },
    // { src: hero5, alt: "LMNT" },
    { src: hero6, alt: "Kswiss",link:"https://www.maxwillsports.com/?srsltid=AfmBOopWLBBzY2cpbqdfg5K_C264ERFHhBgAC-kkxdgn1tSpRYYMX0pf" },
    { src: hero7, alt: "Amazon Pharmacy",link:"https://pickleball.in/" },
  ];
