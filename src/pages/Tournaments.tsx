    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-1 py-6">
        ...
        <div className="w-full flex justify-center mt-6">
          <div className="w-11/12 lg:w-3/4 border border-gray-300 rounded-lg p-4 bg-white mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <div className="relative h-12 mb-4">
                  ...
                  {/* Start thumb */}
                  <div
                    className="absolute top-4 w-4 h-4 bg-black border-2 border-green-500 rounded-full cursor-pointer transform -translate-x-1/2"
