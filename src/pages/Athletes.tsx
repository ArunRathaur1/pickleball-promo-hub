          ...
          <div className="bg-white bg-opacity-30 backdrop-blur-lg rounded-2xl shadow-lg p-8 mb-10 border border-white border-opacity-40">
            ...
            {filteredAthletes.length === 0 ? (
              <div className="text-center py-10 text-emerald-600">
                ...
                <p className="text-lg font-medium">No athletes found matching your filters</p>
                <button 
                  onClick={() => {
                    setSearchTerm("");
                    setGenderFilter("");
              ...
              <div className="overflow-hidden rounded-xl shadow-sm">
                <table className="w-full border-collapse">
                  ...
                  <tbody className="bg-white bg-opacity-60 backdrop-blur-sm">
                    {filteredAthletes.map((athlete, index) => (
                      ...
                      >
                        ...
                        <td className="p-4 border-b border-emerald-100">{athlete.country}</td>
                        <td className="p-4 border-b border-emerald-100">{athlete.age}</td>
                        <td className="p-4 border-b border-emerald-100">
